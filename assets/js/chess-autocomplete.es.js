class It {
  unwrap(e, n) {
    const o = this._chain((s) => B.ok(e ? e(s) : s), (s) => n ? B.ok(n(s)) : B.err(s));
    if (o.isErr)
      throw o.error;
    return o.value;
  }
  map(e, n) {
    return this._chain((o) => B.ok(e(o)), (o) => B.err(n ? n(o) : o));
  }
  chain(e, n) {
    return this._chain(e, n ?? ((o) => B.err(o)));
  }
}
class xn extends It {
  constructor(e) {
...
const mt = (t) => (t = t - (t >>> 1 & 1431655765), t = (t & 858993459) + (t >>> 2 & 858993459), Math.imul(t + (t >>> 4) & 252645135, 16843009) >> 24), Ke = (t) => (t = t >>> 8 & 16711935 | (t & 16711935) << 8, t >>> 16 & 65535 | (t & 65535) << 16), ft = (t) => (t = t >>> 1 & 1431655765 | (t & 1431655765) << 1, t = t >>> 2 & 858993459 | (t & 858993459) << 2, t = t >>> 4 & 252645135 | (t & 252645135) << 4, Ke(t));
class u {
  constructor(e, n) {
  ...
  rbit64() {
    return new u(ft(this.hi), ft(this.lo));
  }
  minus64(e) {
    const n = this.lo - e.lo, o = (n & e.lo & 1) + (e.lo >>> 1) + (n >>> 1) >>> 31;
    return new u(n, this.hi - (e.hi + o));
  }
  equals(e) {
    return this.lo === e.lo && this.hi === e.hi;
  }
  size() {
    return mt(this.lo) + mt(this.hi);
  }
  isEmpty() {
  ...
  *[Symbol.iterator]() {
    ...
    for (; e !== 0; ) {
      const o = 31 - Math.clz32(e & -e);
      e ^= 1 << o, yield o;
    }
    for (; n !== 0; ) {
      const o = 31 - Math.clz32(n & -n);
      n ^= 1 << o, yield 32 + o;
    }
  }
  *reversed() {
    let e = this.lo, n = this.hi;
    for (; n !== 0; ) {
      const o = 31 - Math.clz32(n);
      n ^= 1 << o, yield 32 + o;
    }
    for (; e !== 0; ) {
      const o = 31 - Math.clz32(e);
      e ^= 1 << o, yield o;
    }
  }
}
const ve = ["a", "b", "c", "d", "e", "f", "g", "h"], _t = ["1", "2", "3", "4", "5", "6", "7", "8"], ne = ["white", "black"], ge = ["pawn", "knight", "bishop", "rook", "queen", "king"], Ln = ["a", "h"], ke = (t) => "role" in t, $e = (t) => "from" in t, C = (t) => t !== void 0, T = (t) => t === "white" ? "black" : "white", _ = (t) => t >> 3, S = (t) => t & 7, Dn = (t, e) => 0 <= t && t < 8 && 0 <= e && e < 8 ? t + 8 * e : void 0, re = (t) => {
  switch (t) {
    case "pawn":
      return "p";
    case "knight":
...
function be(t) {
  if (t.length === 2)
    return Dn(t.charCodeAt(0) - 97, t.charCodeAt(1) - 49);
}
const D = (t) => ve[S(t)] + _t[_(t)], Fe = (t) => {
  if (t[1] === "@" && t.length === 4) {
    const e = gt(t[0]), n = be(t.slice(2));
    if (e && C(n))
      return { role: e, to: n };
  } else if (t.length === 4 || t.length === 5) {
    const e = be(t.slice(0, 2)), n = be(t.slice(2, 4));
    let o;
    if (t.length === 5 && (o = gt(t[4]), !o))
      return;
    if (C(e) && C(n))
      return { from: e, to: n, promotion: o };
  }
}, nt = (t, e) => t === "white" ? e === "a" ? 2 : 6 : e === "a" ? 58 : 62, ot = (t, e) => t === "white" ? e === "a" ? 3 : 5 : e === "a" ? 59 : 61, ye = (t, e) => {
  let n = u.empty();
  for (const o of e) {
    const s = t + o;
    0 <= s && s < 64 && Math.abs(S(t) - S(s)) <= 2 && (n = n.with(s));
  }
  return n;
}, W = (t) => {
  const e = [];
  for (let n = 0; n < 64; n++)
    e[n] = t(n);
  return e;
}, An = W((t) => ye(t, [-9, -8, -7, -1, 1, 7, 8, 9])), Rn = W((t) => ye(t, [-17, -15, -10, -6, 6, 10, 15, 17])), On = {
  white: W((t) => ye(t, [7, 9])),
  black: W((t) => ye(t, [-7, -9]))
}, st = (t) => An[t], it = (t) => Rn[t], Ne = (t, e) => On[t][e], Ge = W((t) => u.fromFile(S(t)).without(t)), ze = W((t) => u.fromRank(_(t)).without(t)), Ue = W((t) => {
  const e = new u(134480385, 2151686160), n = 8 * (_(t) - S(t));
  return (n >= 0 ? e.shl64(n) : e.shr64(-n)).without(t);
}), We = W((t) => {
  const e = new u(270549120, 16909320), n = 8 * (_(t) + S(t) - 7);
  return (n >= 0 ? e.shl64(n) : e.shr64(-n)).without(t);
}), qe = (t, e, n) => {
  let o = n.intersect(e), s = o.bswap64();
  return o = o.minus64(t), s = s.minus64(t.bswap64()), o.xor(s.bswap64()).intersect(e);
}, In = (t, e) => qe(u.fromSquare(t), Ge[t], e), _n = (t, e) => {
  const n = ze[t];
  let o = e.intersect(n), s = o.rbit64();
  return o = o.minus64(u.fromSquare(t)), s = s.minus64(u.fromSquare(63 - t)), o.xor(s.rbit64()).intersect(n);
}, ce = (t, e) => {
  const n = u.fromSquare(t);
  return qe(n, Ue[t], e).xor(qe(n, We[t], e));
}, he = (t, e) => In(t, e).xor(_n(t, e)), Ht = (t, e) => ce(t, e).xor(he(t, e)), Kt = (t, e) => {
  const n = u.fromSquare(e);
  return ze[t].intersects(n) ? ze[t].with(t) : We[t].intersects(n) ? We[t].with(t) : Ue[t].intersects(n) ? Ue[t].with(t) : Ge[t].intersects(n) ? Ge[t].with(t) : u.empty();
}, de = (t, e) => Kt(t, e).intersect(u.full().shl64(t).xor(u.full().shl64(e))).withoutFirst();
class ae {
  constructor() {
  }
  static default() {
  ...
  get(e) {
    ...
    if (!n)
      return;
    const o = this.getRole(e), s = this.promoted.has(e);
    return { color: n, role: o, promoted: s };
  }
  /**
  ...
  set(e, n) {
    const o = this.take(e);
    return this.occupied = this.occupied.with(e), this[n.color] = this[n.color].with(e), this[n.role] = this[n.role].with(e), n.promoted && (this.promoted = this.promoted.with(e)), o;
  }
  has(e) {
...
const Hn = (t, e, n, o) => n[e].intersect(he(t, o).intersect(n.rooksAndQueens()).union(ce(t, o).intersect(n.bishopsAndQueens())).union(it(t).intersect(n.knight)).union(st(t).intersect(n.king)).union(Ne(T(e), t).intersect(n.pawn)));
class Y {
  constructor() {
  }
  static default() {
  ...
  add(e, n, o, s) {
    const i = nt(e, n), r = ot(e, n);
    this.castlingRights = this.castlingRights.with(s), this.rook[e][n] = s, this.path[e][n] = de(s, r).with(r).union(de(o, i).with(i)).without(o).without(s);
  }
  static fromSetup(e) {
    const n = Y.empty(), o = e.castlingRights.intersect(e.board.rook);
    for (const s of ne) {
      const i = u.backrank(s), r = e.board.kingOf(s);
      if (!C(r) || !i.has(r))
        continue;
      const a = o.intersect(e.board[s]).intersect(i), l = a.first();
      C(l) && l < r && n.add(s, "a", r, l);
      const c = a.last();
      C(c) && r < c && n.add(s, "h", r, c);
    }
    return n;
  }
  discardRook(e) {
    if (this.castlingRights.has(e)) {
      ...
      for (const n of ne)
        for (const o of Ln)
          this.rook[n][o] === e && (this.rook[n][o] = void 0);
    }
  }
  discardColor(e) {
...
class Kn {
  ...
  // - isStandardMaterial()
  kingAttackers(e, n, o) {
    return Hn(e, n, this.board, o);
  }
  playCaptureAt(e, n) {
    this.halfmoves = 0, n.role === "rook" && this.castles.discardRook(e), this.pockets && this.pockets[T(n.color)][n.promoted ? "pawn" : n.role]++;
  }
  ctx() {
    ...
    const o = he(n, u.empty()).intersect(this.board.rooksAndQueens()).union(ce(n, u.empty()).intersect(this.board.bishopsAndQueens())).intersect(this.board[T(this.turn)]);
    let s = u.empty();
    for (const r of o) {
      const a = de(n, r).intersect(this.board.occupied);
      a.moreThanOne() || (s = s.union(a));
    }
    const i = this.kingAttackers(n, T(this.turn), this.board.occupied);
    return {
      king: n,
      blockers: s,
      checkers: i,
  ...
  clone() {
    ...
    return o.board = this.board.clone(), o.pockets = (e = this.pockets) === null || e === void 0 ? void 0 : e.clone(), o.turn = this.turn, o.castles = this.castles.clone(), o.epSquare = this.epSquare, o.remainingChecks = (n = this.remainingChecks) === null || n === void 0 ? void 0 : n.clone(), o.halfmoves = this.halfmoves, o.fullmoves = this.fullmoves, o;
  }
  validate() {
    if (this.board.occupied.isEmpty())
      return B.err(new te(U.Empty));
    if (this.board.king.size() !== 2)
      return B.err(new te(U.Kings));
    if (!C(this.board.kingOf(this.turn)))
      return B.err(new te(U.Kings));
    const e = this.board.kingOf(T(this.turn));
    return C(e) ? this.kingAttackers(e, this.turn, this.board.occupied).nonEmpty() ? B.err(new te(U.OppositeCheck)) : u.backranks().intersects(this.board.pawn) ? B.err(new te(U.PawnsOnBackrank)) : B.ok(void 0) : B.err(new te(U.Kings));
  }
  dropDests(e) {
    return u.empty();
  }
  dests(e, n) {
    if (n = n || this.ctx(), n.variantEnd)
      return u.empty();
    const o = this.board.get(e);
    if (!o || o.color !== this.turn)
      return u.empty();
    let s, i;
    if (o.role === "pawn") {
      s = Ne(this.turn, e).intersect(this.board[T(this.turn)]);
      const r = this.turn === "white" ? 8 : -8, a = e + r;
      if (0 <= a && a < 64 && !this.board.occupied.has(a)) {
        s = s.with(a);
        const l = this.turn === "white" ? e < 16 : e >= 48, c = a + r;
        l && !this.board.occupied.has(c) && (s = s.with(c));
      }
      C(this.epSquare) && Gn(this, e, n) && (i = u.fromSquare(this.epSquare));
    } else o.role === "bishop" ? s = ce(e, this.board.occupied) : o.role === "knight" ? s = it(e) : o.role === "rook" ? s = he(e, this.board.occupied) : o.role === "queen" ? s = Ht(e, this.board.occupied) : s = st(e);
    if (s = s.diff(this.board[this.turn]), C(n.king)) {
      if (o.role === "king") {
        const r = this.board.occupied.without(e);
        for (const a of s)
          this.kingAttackers(a, T(this.turn), r).nonEmpty() && (s = s.without(a));
        return s.union(bt(this, "a", n)).union(bt(this, "h", n));
      }
      if (n.checkers.nonEmpty()) {
        const r = n.checkers.singleSquare();
        if (!C(r))
          return u.empty();
        s = s.intersect(de(r, n.king).with(r));
      }
      n.blockers.has(e) && (s = s.intersect(Kt(e, n.king)));
    }
    return i && (s = s.union(i)), s;
  }
  isVariantEnd() {
    return !1;
  }
  ...
  hasInsufficientMaterial(e) {
    return this.board[e].intersect(this.board.pawn.union(this.board.rooksAndQueens())).nonEmpty() ? !1 : this.board[e].intersects(this.board.knight) ? this.board[e].size() <= 2 && this.board[T(e)].diff(this.board.king).diff(this.board.queen).isEmpty() : this.board[e].intersects(this.board.bishop) ? (!this.board.bishop.intersects(u.darkSquares()) || !this.board.bishop.intersects(u.lightSquares())) && this.board.pawn.isEmpty() && this.board.knight.isEmpty() : !0;
  }
  ...
  isLegal(e, n) {
      ...
      return !this.pockets || this.pockets[this.turn][e.role] <= 0 || e.role === "pawn" && u.backranks().has(e.to) ? !1 : this.dropDests(n).has(e.to);
    {
      if (e.promotion === "pawn" || e.promotion === "king" && this.rules !== "antichess" || !!e.promotion !== (this.board.pawn.has(e.from) && u.backranks().has(e.to)))
        return !1;
      const o = this.dests(e.from, n);
      return o.has(e.to) || o.has(zn(this, e).to);
    }
  }
  isCheck() {
    const e = this.board.kingOf(this.turn);
    return C(e) && this.kingAttackers(e, T(this.turn), this.board.occupied).nonEmpty();
  }
  isEnd(e) {
  ...
  outcome(e) {
    ...
    return n || (e = e || this.ctx(), this.isCheckmate(e) ? { winner: T(this.turn) } : this.isInsufficientMaterial() || this.isStalemate(e) ? { winner: void 0 } : void 0);
  }
  allDests(e) {
    e = e || this.ctx();
    ...
    if (e.variantEnd)
      return n;
    for (const o of this.board[this.turn])
      n.set(o, this.dests(o, e));
    return n;
  }
  play(e) {
    const n = this.turn, o = this.epSquare, s = $t(this, e);
    if (this.epSquare = void 0, this.halfmoves += 1, n === "black" && (this.fullmoves += 1), this.turn = T(n), ke(e))
      ...
      let r;
      if (i.role === "pawn") {
        this.halfmoves = 0, e.to === o && (r = this.board.take(e.to + (n === "white" ? -8 : 8)));
        const a = e.from - e.to;
        ...
        if (s) {
          const a = this.castles.rook[n][s];
          if (C(a)) {
            const l = this.board.take(a);
            this.board.set(nt(n, s), i), l && this.board.set(ot(n, s), l);
          }
        }
...
class le extends Kn {
  ...
  static fromSetup(e) {
    const n = new this();
    return n.setupUnchecked(e), n.validate().map((o) => n);
  }
  clone() {
    return super.clone();
  }
...
const $n = (t, e) => {
  if (!C(e))
    return;
  const n = t.turn === "white" ? 5 : 2, o = t.turn === "white" ? 8 : -8;
  if (_(e) !== n || t.board.occupied.has(e + o))
    return;
  const s = e - o;
  if (!(!t.board.pawn.has(s) || !t.board[T(t.turn)].has(s)))
    return e;
}, Fn = (t) => {
  if (!C(t.epSquare))
    return;
  const e = t.ctx(), o = t.board.pieces(t.turn, "pawn").intersect(Ne(T(t.turn), t.epSquare));
  for (const s of o)
    if (t.dests(s, e).has(t.epSquare))
      return t.epSquare;
}, Gn = (t, e, n) => {
  ...
  if (!C(n.king))
    return !0;
  const o = t.turn === "white" ? 8 : -8, s = t.epSquare - o;
  return t.kingAttackers(n.king, T(t.turn), t.board.occupied.toggle(e).toggle(s).with(t.epSquare)).without(s).isEmpty();
}, bt = (t, e, n) => {
  if (!C(n.king) || n.checkers.nonEmpty())
    return u.empty();
  const o = t.castles.rook[t.turn][e];
  if (!C(o) || t.castles.path[t.turn][e].intersects(t.board.occupied))
    return u.empty();
  const s = nt(t.turn, e), i = de(n.king, s), r = t.board.occupied.without(n.king);
  for (const c of i)
    if (t.kingAttackers(c, T(t.turn), r).nonEmpty())
      return u.empty();
  const a = ot(t.turn, e), l = t.board.occupied.toggle(n.king).toggle(o).toggle(a);
  return t.kingAttackers(s, T(t.turn), l).nonEmpty() ? u.empty() : u.fromSquare(o);
}, $t = (t, e) => {
  if (ke(e))
    return;
  const n = e.to - e.from;
  ...
  if (!n)
    return e;
  const o = t.castles.rook[t.turn][n];
  return {
    from: e.from,
    to: C(o) ? o : e.to
  };
...
const Un = (t) => {
  ...
  for (let o = 7; o >= 0; o--)
    for (let s = 0; s < 8; s++) {
      const i = s + o * 8, r = t.get(i);
      r ? (n > 0 && (e += n, n = 0), e += Un(r)) : n++, s === 7 && (n > 0 && (e += n, n = 0), o !== 0 && (e += "/"));
    }
  return e;
}, vt = (t) => ge.map((e) => re(e).repeat(t[e])).join(""), qn = (t) => vt(t.white).toUpperCase() + vt(t.black), jn = (t, e) => {
  let n = "";
  for (const o of ne) {
    const s = u.backrank(o);
    let i = t.kingOf(o);
    C(i) && !s.has(i) && (i = void 0);
    const r = t.pieces(o, "rook").intersect(s);
    for (const a of e.intersect(s).reversed())
      if (a === r.first() && C(i) && a < i)
        ...
        const l = ve[S(a)];
        n += o === "white" ? l.toUpperCase() : l;
      }
  }
  return n || "-";
}, Vn = (t) => `${t.white}+${t.black}`, je = (t, e) => [
  ...
  const n = /* @__PURE__ */ new Map(), o = t.ctx();
  for (const [s, i] of t.allDests(o))
    if (i.nonEmpty()) {
      const r = Array.from(i, D);
      s === o.king && S(s) === 4 && (i.has(0) ? r.push("c1") : i.has(56) && r.push("c8"), i.has(7) ? r.push("g1") : i.has(63) && r.push("g8")), n.set(D(s), r);
    }
  return n;
}, Qn = (t, e) => {
  let n = "";
  if (ke(e))
    ...
    const o = t.board.getRole(e.from);
    if (!o)
      return "--";
    if (o === "king" && (t.board[t.turn].has(e.to) || Math.abs(e.to - e.from) === 2))
      n = e.to > e.from ? "O-O" : "O-O-O";
    else {
      const s = t.board.occupied.has(e.to) || o === "pawn" && S(e.from) !== S(e.to);
      if (o !== "pawn") {
        n = re(o).toUpperCase();
        let i;
        if (o === "king" ? i = st(e.to).intersect(t.board.king) : o === "queen" ? i = Ht(e.to, t.board.occupied).intersect(t.board.queen) : o === "rook" ? i = he(e.to, t.board.occupied).intersect(t.board.rook) : o === "bishop" ? i = ce(e.to, t.board.occupied).intersect(t.board.bishop) : i = it(e.to).intersect(t.board.knight), i = i.intersect(t.board[t.turn]).without(e.from), i.nonEmpty()) {
          const r = t.ctx();
          for (const a of i)
            t.dests(a, r).has(e.to) || (i = i.without(a));
          if (i.nonEmpty()) {
            let a = !1, l = i.intersects(u.fromRank(_(e.from)));
            i.intersects(u.fromFile(S(e.from))) ? a = !0 : l = !0, l && (n += ve[S(e.from)]), a && (n += _t[_(e.from)]);
          }
        }
      } else s && (n = ve[S(e.from)]);
      s && (n += "x"), n += D(e.to), e.promotion && (n += "=" + re(e.promotion).toUpperCase());
    }
  }
  return n;
}, Zn = (t, e) => {
  var n;
  const o = Qn(t, e);
  return t.play(e), !((n = t.outcome()) === null || n === void 0) && n.winner ? o + "#" : t.isCheck() ? o + "+" : o;
}, Yn = (t, e) => Zn(t.clone(), e), Jn = ["white", "black"], Ce = ["a", "b", "c", "d", "e", "f", "g", "h"], Me = ["1", "2", "3", "4", "5", "6", "7", "8"], eo = [...Me].reverse(), Te = Ce.flatMap((t) => Me.map((e) => t + e)), oe = (t) => t.every((e) => e >= 0 && e <= 7) ? Te[8 * t[0] + t[1]] : void 0, Q = (t) => oe(t), M = (t) => [t.charCodeAt(0) - 97, t.charCodeAt(1) - 49], Ft = Te.map(M), to = Te.map((t, e) => ({ key: t, pos: Ft[e] }));
function Gt(t) {
  let e;
...
}, pe = (t) => t === "white" ? "black" : "white", ue = (t, e) => (t[0] - e[0]) ** 2 + (t[1] - e[1]) ** 2, Ve = (t, e) => t.role === e.role && t.color === e.color, oo = (t, e) => t[0] === e[0] && t[1] === e[1], me = (t) => (e, n) => [
...
}, so = Gt(() => !("ontouchstart" in window) && ["macintosh", "firefox"].every((t) => navigator.userAgent.toLowerCase().includes(t))), Ut = (t) => t.button === 2 && !(t.ctrlKey && so()), F = (t, e) => {
...
const q = (t, e) => Math.abs(t - e), qt = (t, e, n, o) => q(t, n) * q(e, o) === 2, jt = (t, e, n, o) => t === n != (e === o), Vt = (t, e, n, o) => q(t, n) === q(e, o) && t !== n, io = (t, e, n, o) => jt(t, e, n, o) || Vt(t, e, n, o), ro = (t, e, n, o) => Math.max(q(t, n), q(e, o)) === 1, ao = (t, e, n, o, s) => {
  const i = s ? 1 : -1;
  return t === n && (o === e + i || // allow 2 squares from first two ranks, for horde
  o === e + 2 * i && (s ? e <= 1 : e >= 6));
}, lo = (t, e, n, o) => {
  const s = n - t, i = o - e;
  if (s && i && Math.abs(s) !== Math.abs(i))
    return [];
  const r = Math.sign(s), a = Math.sign(i), l = [];
  let c = t + r, d = e + a;
  for (; c !== n || d !== o; )
    l.push([c, d]), c += r, d += a;
  return l.map(oe).filter((h) => h !== void 0);
}, co = (t) => q(t.orig.pos[0], t.dest.pos[0]) <= 1 && (q(t.orig.pos[0], t.dest.pos[0]) === 1 ? t.dest.pos[1] === t.orig.pos[1] + (t.color === "white" ? 1 : -1) : ao(...t.orig.pos, ...t.dest.pos, t.color === "white")), ho = (t) => qt(...t.orig.pos, ...t.dest.pos), Xt = (t) => Vt(...t.orig.pos, ...t.dest.pos), Qt = (t) => jt(...t.orig.pos, ...t.dest.pos), uo = (t) => Xt(t) || Qt(t), po = (t) => ro(...t.orig.pos, ...t.dest.pos) || t.orig.pos[1] === t.dest.pos[1] && t.orig.pos[1] === (t.color === "white" ? 0 : 7) && (t.orig.pos[0] === 4 && (t.dest.pos[0] === 2 && t.rookFilesFriendlies.includes(0) || t.dest.pos[0] === 6 && t.rookFilesFriendlies.includes(7)) || t.rookFilesFriendlies.includes(t.dest.pos[0])), mo = { pawn: co, knight: ho, bishop: Xt, rook: Qt, queen: uo, king: po };
function Zt(t, e) {
  const n = t.pieces, o = n.get(e);
  if (!o || o.color === t.turnColor)
    return [];
  const s = o.color, i = new Map([...n].filter(([d, h]) => h.color === s)), r = new Map([...n].filter(([d, h]) => h.color === pe(s))), a = { key: e, pos: M(e) }, l = (d) => mo[o.role](d) && t.premovable.additionalPremoveRequirements(d), c = {
    orig: a,
    role: o.role,
    allPieces: n,
    friendlies: i,
    enemies: r,
    color: s,
    rookFilesFriendlies: Array.from(n).filter(([d, h]) => d[1] === (s === "white" ? "1" : "8") && h.color === s && h.role === "rook").map(([d]) => M(d)[0]),
    lastMove: t.lastMove
  };
  return to.filter((d) => l({ ...c, dest: d })).map((d) => d.key);
}
function A(t, ...e) {
  t && setTimeout(() => t(...e), 1);
}
...
function go(t, e) {
  for (const [n, o] of e)
    o ? t.pieces.set(n, o) : t.pieces.delete(n);
}
function bo(t, e) {
  if (t.check = void 0, e === !0 && (e = t.turnColor), e)
    for (const [n, o] of t.pieces)
      o.role === "king" && o.color === e && (t.check = n);
}
function wo(t, e, n, o) {
  V(t), t.premovable.current = [e, n], A(t.premovable.events.set, e, n, o);
}
function j(t) {
  t.premovable.current && (t.premovable.current = void 0, A(t.premovable.events.unset));
}
function vo(t, e, n) {
  j(t), t.predroppable.current = { role: e, key: n }, A(t.predroppable.events.set, e, n);
}
function V(t) {
  const e = t.predroppable;
  e.current && (e.current = void 0, A(e.events.unset));
}
function ko(t, e, n) {
  if (!t.autoCastle)
    return !1;
  ...
  if (!o || o.role !== "king")
    return !1;
  const s = M(e), i = M(n);
  if (s[1] !== 0 && s[1] !== 7 || s[1] !== i[1])
    return !1;
  s[0] === 4 && !t.pieces.has(n) && (i[0] === 6 ? n = Q([7, i[1]]) : i[0] === 2 && (n = Q([0, i[1]])));
  const r = t.pieces.get(n);
  return !r || r.color !== o.color || r.role !== "rook" ? !1 : (t.pieces.delete(e), t.pieces.delete(n), s[0] < i[0] ? (t.pieces.set(Q([6, i[1]]), o), t.pieces.set(Q([5, i[1]]), r)) : (t.pieces.set(Q([2, i[1]]), o), t.pieces.set(Q([3, i[1]]), r)), !0);
}
function Yt(t, e, n) {
  const o = t.pieces.get(e), s = t.pieces.get(n);
  if (e === n || !o)
    return !1;
  const i = s && s.color !== o.color ? s : void 0;
  return n === t.selected && I(t), A(t.events.move, e, n, i), ko(t, e, n) || (t.pieces.set(n, o), t.pieces.delete(e)), t.lastMove = [e, n], t.check = void 0, A(t.events.change), i || !0;
}
function at(t, e, n, o) {
  if (t.pieces.has(n))
    if (o)
      ...
      return !1;
  return A(t.events.dropNewPiece, e, n), t.pieces.set(n, e), t.lastMove = [n], t.check = void 0, A(t.events.change), t.movable.dests = void 0, t.turnColor = pe(t.turnColor), !0;
}
function Jt(t, e, n) {
  const o = Yt(t, e, n);
  return o && (t.movable.dests = void 0, t.turnColor = pe(t.turnColor), t.animation.current = void 0), o;
}
function en(t, e, n) {
  if (lt(t, e, n)) {
    const o = Jt(t, e, n);
    if (o) {
      ...
      return o !== !0 && (i.captured = o), A(t.movable.events.after, e, n, i), !0;
    }
  } else if (Co(t, e, n))
    return wo(t, e, n, {
      ctrlKey: t.stats.ctrlKey
...
function tn(t, e, n, o) {
  ...
  s && (yo(t, e, n) || o) ? (t.pieces.delete(e), at(t, s, n, o), A(t.movable.events.afterNewPiece, s.role, n, {
    premove: !1,
    predrop: !1
  })) : s && Mo(t, e, n) ? vo(t, s.role, n) : (j(t), V(t)), t.pieces.delete(e), I(t);
}
function Xe(t, e, n) {
  if (A(t.events.select, e), t.selected) {
  ...
  (t.selectable.enabled || t.draggable.enabled) && (on(t, e) || ct(t, e)) && (nn(t, e), t.hold.start());
}
function nn(t, e) {
  t.selected = e, ct(t, e) ? t.premovable.customDests || (t.premovable.dests = Zt(t, e)) : t.premovable.dests = void 0;
}
function I(t) {
...
const lt = (t, e, n) => {
  var o, s;
  return e !== n && on(t, e) && (t.movable.free || !!((s = (o = t.movable.dests) == null ? void 0 : o.get(e)) != null && s.includes(n)));
};
function yo(t, e, n) {
  const o = t.pieces.get(e);
  return !!o && (e === n || !t.pieces.has(n)) && (t.movable.color === "both" || t.movable.color === o.color && t.turnColor === o.color);
}
function ct(t, e) {
  const n = t.pieces.get(e);
...
const Co = (t, e, n) => {
  var o;
  return e !== n && ct(t, e) && (((o = t.premovable.customDests) == null ? void 0 : o.get(e)) ?? Zt(t, e)).includes(n);
};
function Mo(t, e, n) {
  const o = t.pieces.get(e), s = t.pieces.get(n);
  return !!o && (!s || s.color !== t.movable.color) && t.predroppable.enabled && (o.role !== "pawn" || n[1] !== "1" && n[1] !== "8") && t.movable.color === o.color && t.turnColor !== o.color;
}
function Eo(t, e) {
  const n = t.pieces.get(e);
...
function Po(t) {
  ...
  if (lt(t, n, o)) {
    ...
    if (i) {
      const r = { premove: !0 };
      i !== !0 && (r.captured = i), A(t.movable.events.after, n, o, r), s = !0;
    }
  }
  return j(t), s;
}
function So(t, e) {
  ...
  if (e(n)) {
    ...
    at(t, s, n.key) && (A(t.movable.events.afterNewPiece, n.role, n.key, {
      premove: !1,
      predrop: !0
    }), o = !0);
  }
...
function kt(t) {
  t.movable.color = t.movable.dests = t.animation.current = void 0, ht(t);
}
function ee(t, e, n) {
  let o = Math.floor(8 * (t[0] - n.left) / n.width);
  e || (o = 7 - o);
  let s = 7 - Math.floor(8 * (t[1] - n.top) / n.height);
  return e || (s = 7 - s), o >= 0 && o < 8 && s >= 0 && s < 8 ? oe([o, s]) : void 0;
}
function No(t, e, n, o) {
  const s = M(t), i = Ft.filter((c) => oo(s, c) || io(s[0], s[1], c[0], c[1]) || qt(s[0], s[1], c[0], c[1])), a = i.map((c) => Wt(Q(c), n, o)).map((c) => ue(e, c)), [, l] = a.reduce((c, d, h) => c[0] < d ? c : [d, h], [a[0], 0]);
  return oe(i[l]);
}
const R = (t) => t.orientation === "white", sn = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR", To = {
  p: "pawn",
  r: "rook",
  n: "knight",
  b: "bishop",
    ...
    switch (s) {
      ...
      default: {
        ...
        if (i < 57)
          ...
          const r = s.toLowerCase(), a = oe([o, n]);
          a && e.set(a, {
            role: To[r],
            color: s === r ? "black" : "white"
          }), ++o;
        }
      }
    }
...
function Bo(t) {
  return eo.map((e) => Ce.map((n) => {
    const o = t.get(n + e);
    if (o) {
      let s = xo[o.role];
      return o.color === "white" && (s = s.toUpperCase()), o.promoted && (s += "~"), s;
    } else
      return "1";
  }).join("")).join("/").replace(/1{2,}/g, (e) => e.length.toString());
}
function an(t, e) {
  e.animation && (dt(t.animation, e.animation), (t.animation.duration || 0) < 70 && (t.animation.enabled = !1));
}
function ln(t, e) {
  var n, o, s;
  if ((n = e.movable) != null && n.dests && (t.movable.dests = void 0), (o = e.drawable) != null && o.autoShapes && (t.drawable.autoShapes = []), dt(t, e), e.fen && (t.pieces = rn(e.fen), t.drawable.shapes = ((s = e.drawable) == null ? void 0 : s.shapes) || []), "check" in e && bo(t, e.check || !1), "lastMove" in e && !e.lastMove ? t.lastMove = void 0 : e.lastMove && (t.lastMove = e.lastMove), t.selected && nn(t, t.selected), an(t, e), !t.movable.rookCastle && t.movable.dests) {
...
function dt(t, e) {
  for (const n in e)
    n === "__proto__" || n === "constructor" || !Object.prototype.hasOwnProperty.call(e, n) || (Object.prototype.hasOwnProperty.call(t, n) && yt(t[n]) && yt(e[n]) ? dt(t[n], e[n]) : t[n] = e[n]);
}
function yt(t) {
...
const Z = (t, e) => e.animation.enabled ? Ao(t, e) : z(t, e);
function z(t, e) {
  const n = t(e);
...
const xe = (t, e) => ({
  ...
  pos: M(t),
  piece: e
}), Lo = (t, e) => e.sort((n, o) => ue(t.pos, n.pos) - ue(t.pos, o.pos))[0];
function Do(t, e) {
  const n = /* @__PURE__ */ new Map(), o = [], s = /* @__PURE__ */ new Map(), i = [], r = [], a = /* @__PURE__ */ new Map();
  let l, c, d;
  for (const [h, p] of t)
    a.set(h, xe(h, p));
  for (const h of Te)
    l = e.pieces.get(h), c = a.get(h), l ? c ? Ve(l, c.piece) || (i.push(c), r.push(xe(h, l))) : r.push(xe(h, l)) : c && i.push(c);
  for (const h of r)
    c = Lo(h, i.filter((p) => Ve(h.piece, p.piece))), c && (d = [c.pos[0] - h.pos[0], c.pos[1] - h.pos[1]], n.set(h.key, d.concat(d)), o.push(c.key));
  for (const h of i)
    o.includes(h.key) || s.set(h.key, h.piece);
  return {
    anims: n,
    fadings: s
  };
...
function cn(t, e) {
  ...
  const o = 1 - (e - n.start) * n.frequency;
  if (o <= 0)
...
function Ao(t, e) {
  const n = new Map(e.pieces), o = t(e), s = Do(n, e);
...
const Ro = (t) => t < 0.5 ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1, Oo = ["green", "red", "blue", "yellow"];
function Io(t, e) {
  if (e.touches && e.touches.length > 1)
    return;
  e.stopPropagation(), e.preventDefault(), e.ctrlKey ? I(t) : ht(t);
  const n = J(e), o = ee(n, R(t), t.dom.bounds());
...
function hn(t) {
  requestAnimationFrame(() => {
    ...
    if (e) {
      const n = ee(e.pos, R(t), t.dom.bounds());
      n || (e.snapToValidMove = !1);
      const o = e.snapToValidMove ? No(e.orig, e.pos, R(t), t.dom.bounds()) : n;
      o !== e.mouseSq && (e.mouseSq = o, e.dest = o !== e.orig ? o : void 0, t.dom.redrawNow()), hn(t);
    }
  });
}
function _o(t, e) {
...
function Ho(t) {
  const e = t.drawable.current;
  e && (e.mouseSq && Fo(t.drawable, e), dn(t));
}
function dn(t) {
...
const Qe = (t, e) => t.orig === e.orig && t.dest === e.dest, un = (t, e) => t.brush === e.brush;
function $o(t) {
  var o;
  const e = (t.shiftKey || t.ctrlKey) && Ut(t), n = t.altKey || t.metaKey || ((o = t.getModifierState) == null ? void 0 : o.call(t, "AltGraph"));
  return Oo[(e ? 1 : 0) + (n ? 2 : 0)];
}
function Fo(t, e) {
  const n = t.shapes.find((o) => Qe(o, e));
  n && (t.shapes = t.shapes.filter((o) => !Qe(o, e))), (!n || !un(n, e)) && t.shapes.push({
    orig: e.orig,
    dest: e.dest,
    brush: e.brush
  }), pn(t);
...
function Go(t, e) {
  if (!(t.trustAllEvents || e.isTrusted) || e.buttons !== void 0 && e.buttons > 1 || e.touches && e.touches.length > 1)
    return;
  const n = t.dom.bounds(), o = J(e), s = ee(o, R(t), n);
  if (!s)
    return;
  const i = t.pieces.get(s), r = t.selected;
  if (!r && t.drawable.enabled && (t.drawable.eraseOnMovablePieceClick || !i || i.color !== t.turnColor) && Ko(t), e.cancelable !== !1 && (!e.touches || t.blockTouchScroll || i || r || zo(t, o)))
    e.preventDefault();
  else if (e.touches)
    return;
  const a = !!t.premovable.current, l = !!t.predroppable.current;
  t.stats.ctrlKey = e.ctrlKey, t.selected && lt(t, t.selected, s) ? Z((h) => Xe(h, s), t) : Xe(t, s);
  const c = t.selected === s, d = fn(t, s);
  if (i && d && c && Eo(t, s)) {
    t.draggable.current = {
      orig: s,
      piece: i,
    ...
    h && (h.className = `ghost ${i.color} ${i.role}`, K(h, me(n)(M(s), R(t))), rt(h, !0)), ut(t);
  } else
    a && j(t), l && V(t);
  t.dom.redraw();
}
function zo(t, e) {
  const n = R(t), o = t.dom.bounds(), s = Math.pow(t.touchIgnoreRadius * o.width / 16, 2) * 2;
...
function ut(t) {
  requestAnimationFrame(() => {
    ...
    if (!e)
      return;
    (o = t.animation.current) != null && o.plan.anims.has(e.orig) && (t.animation.current = void 0);
    ...
    if (!n || !Ve(n, e.piece))
      ...
      const s = t.dom.bounds();
      K(e.element, [
        e.pos[0] - s.left - s.width / 16,
        e.pos[1] - s.top - s.height / 16
      ]), e.keyHasChanged || (e.keyHasChanged = e.orig !== ee(e.pos, R(t), s));
    }
    ut(t);
  });
}
...
function qo(t, e) {
  ...
  j(t), V(t);
  const o = J(e) || n.pos, s = ee(o, R(t), t.dom.bounds());
  s && n.started && n.orig !== s ? n.newPiece ? tn(t, n.orig, s, n.force) : (t.stats.ctrlKey = e.ctrlKey, en(t, n.orig, s) && (t.stats.dragged = !0)) : n.newPiece ? t.pieces.delete(n.orig) : t.draggable.deleteOnDropOff && !s && (t.pieces.delete(n.orig), A(t.events.change)), (n.orig === n.previouslySelected || n.keyHasChanged) && (n.orig === s || !s) ? I(t) : t.selectable.enabled || I(t), mn(t), t.draggable.current = void 0, t.dom.redraw();
}
function Ee(t) {
  const e = t.draggable.current;
  e && (e.newPiece && t.pieces.delete(e.orig), t.draggable.current = void 0, I(t), mn(t), t.dom.redraw());
}
function mn(t) {
  const e = t.dom.elements;
  e.ghost && rt(e.ghost, !1);
}
function fn(t, e) {
...
function jo(t, e) {
  t.exploding = { stage: 1, keys: e }, t.dom.redraw(), setTimeout(() => {
    Ct(t, 2), setTimeout(() => Ct(t, void 0), 120);
  }, 120);
}
function Ct(t, e) {
...
function Vo(t, e) {
  ...
  return {
    set(o) {
      o.orientation && o.orientation !== t.orientation && n(), an(t, o), (o.fen ? Z : z)((s) => ln(s, o), t);
    },
    state: t,
    getFen: () => Bo(t.pieces),
    toggleOrientation: n,
    ...
    selectSquare(o, s) {
      o ? Z((i) => Xe(i, o, s), t) : t.selected && (I(t), t.dom.redraw());
    },
    move(o, s) {
      Z((i) => Yt(i, o, s), t);
    },
    ...
    setAutoShapes(o) {
      z((s) => s.drawable.autoShapes = o, t);
    },
    setShapes(o) {
      z((s) => s.drawable.shapes = o.slice(), t);
    },
    getKeyAtDomPos(o) {
      return ee(o, R(t), t.dom.bounds());
    },
    redrawAll: e,
    dragNewPiece(o, s, i) {
      Uo(t, o, s, i);
    ...
    destroy() {
      kt(t), t.dom.unbind && t.dom.unbind(), t.dom.destroyed = !0;
    }
  };
}
function Xo() {
...
function Qo() {
  const t = N("defs"), e = L(N("filter"), { id: "cg-filter-blur" });
  return e.appendChild(L(N("feGaussianBlur"), { stdDeviation: "0.013" })), t.appendChild(e), t;
}
function Zo(t, e) {
  const n = t.drawable, o = n.current, s = o && o.mouseSq ? o : void 0, i = /* @__PURE__ */ new Map(), r = t.dom.bounds(), a = n.autoShapes.filter((h) => !h.piece);
  for (const h of n.shapes.concat(a).concat(s ? [s] : [])) {
    if (!h.dest)
      continue;
    const p = i.get(h.dest) ?? /* @__PURE__ */ new Set(), m = Se(Pe(M(h.orig), t.orientation), r), g = Se(Pe(M(h.dest), t.orientation), r);
    p.add(Cn(Mn(m, g))), i.set(h.dest, p);
  }
  const l = [], c = s ? n.shapes.findIndex((h) => Qe(h, s) && un(h, s)) : -1;
  for (const [h, p] of n.shapes.concat(a).entries()) {
    ...
    l.push({
      ...
      current: !1,
      pendingErase: m,
      hash: Mt(p, Ze(p.dest, i), !1, r, m, Pt(p.dest, i))
    });
  }
  s && c === -1 && l.push({
    shape: s,
    current: !0,
    hash: Mt(s, Ze(s.dest, i), !0, r, !1, Pt(s.dest, i)),
    pendingErase: !1
  });
  const d = l.map((h) => h.hash).join(";");
  d !== t.drawable.prevSvgHash && (t.drawable.prevSvgHash = d, Yo(n, l, e), Jo(l, e, (h) => ns(t, h, n.brushes, i, r)));
}
function Yo(t, e, n) {
  for (const o of [n.shapes, n.shapesBelow]) {
    const s = o.querySelector("defs"), i = e.filter((c) => o === n.shapesBelow == !!c.shape.below), r = /* @__PURE__ */ new Map();
...
function Jo(t, e, n) {
  for (const [o, s] of [
    ...
    const [i, r] = [o, s].map((c) => c.querySelector("g")), a = t.filter((c) => o === e.shapesBelow == !!c.shape.below), l = /* @__PURE__ */ new Map();
    for (const c of a)
      l.set(c.hash, !1);
    for (const c of [i, r]) {
      const d = [];
...
function Mt({ orig: t, dest: e, brush: n, piece: o, modifiers: s, customSvg: i, label: r, below: a }, l, c, d, h, p) {
  var m;
  return [
    d.width,
    d.height,
...
const es = (t) => [t.color, t.role, t.scale].filter((e) => e).join(","), ts = (t) => [t.lineWidth, t.hilite].filter((e) => e).join(",");
function Et(t) {
  let e = 0;
...
function ns(t, { shape: e, current: n, pendingErase: o, hash: s }, i, r, a) {
  const l = Se(Pe(M(e.orig), t.orientation), a), c = e.dest ? Se(Pe(M(e.dest), t.orientation), a) : l, d = e.brush && vn(i[e.brush], e.modifiers), h = r.get(e.dest), p = [];
  if (d) {
    const m = L(N("g"), { cgHash: s });
    p.push({ el: m }), l[0] !== c[0] || l[1] !== c[1] ? m.appendChild(ss(e, d, l, c, n, Ze(e.dest, r), o)) : m.appendChild(os(i[e.brush], l, n, a, o));
  }
  if (e.label) {
    const m = e.label;
    m.fill ?? (m.fill = e.brush && i[e.brush].color);
    const g = e.brush ? void 0 : "tr";
    p.push({ el: rs(m, s, l, c, h, g), isCustom: !0 });
  }
  if (e.customSvg) {
    const m = e.customSvg.center ?? "orig", [g, f] = m === "label" ? En(l, c, h).map((k) => k - 0.5) : m === "dest" ? c : l, b = L(N("g"), { transform: `translate(${g},${f})`, cgHash: s });
    b.innerHTML = `<svg width="1" height="1" viewBox="0 0 100 100">${e.customSvg.html}</svg>`, p.push({ el: b, isCustom: !0 });
  }
  return p;
}
function os(t, e, n, o, s) {
  const i = as(), r = (o.width + o.height) / (4 * Math.max(o.width, o.height));
  return L(N("circle"), {
    stroke: t.color,
...
function ss(t, e, n, o, s, i, r) {
  var d;
  function a(h) {
    var v;
    const p = cs(i && !s), m = o[0] - n[0], g = o[1] - n[1], f = Math.atan2(g, m), b = Math.cos(f) * p, k = Math.sin(f) * p, y = kn(t);
    return L(N("line"), {
      stroke: h ? y.color : e.color,
      "stroke-width": ls(e, s) * (h ? 1.14 : 1),
      "stroke-linecap": "round",
      "marker-end": `url(#arrowhead-${h ? y.key : e.key})`,
      opacity: (v = t.modifiers) != null && v.hilite && !r ? 1 : yn(e, s, r),
      x1: n[0],
      y1: n[1],
      x2: o[0] - b,
      y2: o[1] - k
  ...
  if (!((d = t.modifiers) != null && d.hilite))
    return a(!1);
  const l = L(N("g"), { opacity: e.opacity }), c = L(N("g"), { filter: "url(#cg-filter-blur)" });
  return c.appendChild(hs(n, o)), c.appendChild(a(!0)), l.appendChild(c), l.appendChild(a(!1)), l;
}
function is(t) {
  const e = L(N("marker"), {
    id: "arrowhead-" + t.key,
  ...
  return e.appendChild(L(N("path"), {
    d: "M0,0 V4 L3,2 Z",
    fill: t.color
  })), e.setAttribute("cgKey", t.key), e;
}
function rs(t, e, n, o, s, i) {
  const a = 0.4 * 0.75 ** t.text.length, l = En(n, o, s), c = i === "tr" ? 0.4 : 0, d = L(N("g"), {
    transform: `translate(${l[0] + c},${l[1] - c})`,
    cgHash: e
  });
  d.appendChild(L(N("circle"), {
    r: 0.4 / 2,
...
const Pe = (t, e) => e === "white" ? t : [7 - t[0], 7 - t[1]], gn = (t, e) => (t % e + e) % e, bn = (t, e) => gn(t + e, 16), wn = (t) => [...t].some((e) => [-3, -2, -1, 1, 2, 3].some((n) => t.has(bn(e, n)))), Ze = (t, e) => !!t && e.has(t) && wn(e.get(t)), N = (t) => document.createElementNS("http://www.w3.org/2000/svg", t), Pt = (t, e) => t && e.has(t) ? e.get(t).size : 0;
function L(t, e) {
  for (const n in e)
...
} : t, as = () => [3 / 64, 4 / 64], ls = (t, e) => (t.lineWidth || 10) * (e ? 0.85 : 1) / 64;
function kn(t) {
  var n;
  const e = (n = t.modifiers) == null ? void 0 : n.hilite;
  return { key: e && `hilite-${e.replace("#", "")}`, color: e };
}
const yn = (t, e, n) => (t.opacity || 1) * (n ? 0.6 : e ? 0.9 : 1), cs = (t) => (t ? 20 : 10) / 64;
function Se(t, e) {
  const n = Math.min(1, e.width / e.height), o = Math.min(1, e.height / e.width);
  return [(t[0] - 3.5) * n, (3.5 - t[1]) * o];
}
function hs(t, e) {
  const n = {
...
const Cn = (t) => gn(Math.round(t * 8 / Math.PI), 16), Mn = (t, e) => Math.atan2(e[1] - t[1], e[0] - t[0]) + Math.PI, ds = (t, e) => Math.sqrt([t[0] - e[0], t[1] - e[1]].reduce((n, o) => n + o * o, 0));
function En(t, e, n) {
  let o = ds(t, e);
  const s = Mn(t, e);
  if (n && (o -= 33 / 64, wn(n))) {
    o -= 10 / 64;
    const i = Cn(s);
    i & 1 && [-1, 1].some((r) => n.has(bn(i, r))) && (o -= 0.4);
  }
  return [t[0] - Math.cos(s) * o, t[1] - Math.sin(s) * o].map((i) => i + 0.5);
}
function us(t, e) {
  ...
  const n = F("cg-container");
  t.appendChild(n);
  const o = F("cg-board");
  n.appendChild(o);
  let s, i, r, a, l;
  if (e.drawable.visible && ([s, i] = ["cg-shapes-below", "cg-shapes"].map((d) => St(d, !0)), [r, a] = ["cg-custom-below", "cg-custom-svgs"].map((d) => St(d, !1)), l = F("cg-auto-pieces"), n.appendChild(s), n.appendChild(r), n.appendChild(i), n.appendChild(a), n.appendChild(l)), e.coordinates) {
    ...
    if (e.coordinatesOnSquares) {
      ...
      Ce.forEach((m, g) => n.appendChild(Be(Me.map((f) => m + f), "squares rank" + p(g) + d + h, g % 2 === 0 ? "black" : "white")));
    } else
      n.appendChild(Be(Me, "ranks" + d + h, e.ranksPosition === "right" == (e.orientation === "white") ? "white" : "black")), n.appendChild(Be(Ce, "files" + d, pe(e.orientation)));
  }
  let c;
  return e.draggable.enabled && e.draggable.showGhost && (c = F("piece", "ghost"), rt(c, !1), n.appendChild(c)), { board: o, container: n, wrap: t, ghost: c, shapes: i, shapesBelow: s, custom: a, customBelow: r, autoPieces: l };
}
function St(t, e) {
  const n = L(N("svg"), {
    class: t,
  ...
  return e && n.appendChild(Qo()), n.appendChild(N("g")), n;
}
function Be(t, e, n) {
  const o = F("coords", e);
  let s;
  return t.forEach((i, r) => {
    ...
    s = F("coord", `coord-${a ? "light" : "dark"}`), s.textContent = i, o.appendChild(s);
  }), o;
}
function ps(t, e) {
  ...
  if (n) {
    t.pieces.set("a0", n);
    const o = J(e), s = o && ee(o, R(t), t.dom.bounds());
    s && tn(t, "a0", s);
  }
  t.dom.redraw();
}
function ms(t, e) {
  ...
  if ("ResizeObserver" in window && new ResizeObserver(e).observe(t.dom.elements.wrap), (t.disableContextMenu || t.drawable.enabled) && n.addEventListener("contextmenu", (s) => s.preventDefault()), t.viewOnly)
    return;
  const o = gs(t);
...
function fs(t, e) {
  const n = [];
  if ("ResizeObserver" in window || n.push(se(document.body, "chessground.resize", e)), !t.viewOnly) {
    const o = Nt(t, Wo, _o), s = Nt(t, qo, Ho);
    for (const r of ["touchmove", "mousemove"])
      n.push(se(document, r, o));
    for (const r of ["touchend", "mouseup"])
      n.push(se(document, r, s));
    const i = () => t.dom.bounds.clear();
    n.push(se(document, "scroll", i, { capture: !0, passive: !0 })), n.push(se(window, "resize", i, { passive: !0 }));
  }
...
const gs = (t) => (e) => {
  t.draggable.current ? Ee(t) : t.drawable.current ? dn(t) : e.shiftKey || Ut(e) ? t.drawable.enabled && Io(t, e) : t.viewOnly || (t.dropmode.active ? ps(t, e) : Go(t, e));
}, Nt = (t, e, n) => (o) => {
  t.drawable.current ? t.drawable.enabled && n(t, o) : t.viewOnly || e(t, o);
};
function bs(t) {
  const e = R(t), n = me(t.dom.bounds()), o = t.dom.elements.board, s = t.pieces, i = t.animation.current, r = i ? i.plan.anims : /* @__PURE__ */ new Map(), a = i ? i.plan.fadings : /* @__PURE__ */ new Map(), l = t.draggable.current, c = ks(t), d = /* @__PURE__ */ new Set(), h = /* @__PURE__ */ new Set(), p = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ new Map();
  let g, f, b, k, y, v, O, E, G, X;
  for (f = o.firstChild; f; ) {
    if (g = f.cgKey, Pn(f))
      if (b = s.get(g), y = r.get(g), v = a.get(g), k = f.cgPiece, f.cgDragging && (!l || l.orig !== g) && (f.classList.remove("dragging"), K(f, n(M(g), e)), f.cgDragging = !1), !v && f.cgFading && (f.cgFading = !1, f.classList.remove("fading")), b) {
        if (y && f.cgAnimating && k === ie(b)) {
          const w = M(g);
          w[0] += y[2], w[1] += y[3], f.classList.add("anim"), K(f, n(w, e));
        } else f.cgAnimating && (f.cgAnimating = !1, f.classList.remove("anim"), K(f, n(M(g), e)), t.addPieceZIndex && (f.style.zIndex = Le(M(g), e)));
        k === ie(b) && (!v || !f.cgFading) ? d.add(g) : v && k === ie(v) ? (f.classList.add("fading"), f.cgFading = !0) : De(p, k, f);
      } else
        De(p, k, f);
    else if (Sn(f)) {
      const w = f.className;
      c.get(g) === w ? h.add(g) : De(m, w, f);
    }
    f = f.nextSibling;
  }
  for (const [w, P] of c)
    if (!h.has(w)) {
      ...
      if (X)
        ...
        const H = F("square", P);
        H.cgKey = w, K(H, x), o.insertBefore(H, o.firstChild);
      }
    }
  for (const [w, P] of s)
    if (y = r.get(w), !d.has(w))
      if (O = p.get(ie(P)), E = O && O.pop(), E) {
        E.cgKey = w, E.cgFading && (E.classList.remove("fading"), E.cgFading = !1);
        const x = M(w);
        t.addPieceZIndex && (E.style.zIndex = Le(x, e)), y && (E.cgAnimating = !0, E.classList.add("anim"), x[0] += y[2], x[1] += y[3]), K(E, n(x, e));
      } else {
        const x = ie(P), H = F("piece", x), fe = M(w);
        H.cgPiece = x, H.cgKey = w, y && (H.cgAnimating = !0, fe[0] += y[2], fe[1] += y[3]), K(H, n(fe, e)), t.addPieceZIndex && (H.style.zIndex = Le(fe, e)), o.appendChild(H);
      }
...
function ws(t) {
  const e = R(t), n = me(t.dom.bounds());
  let o = t.dom.elements.board.firstChild;
  for (; o; )
    (Pn(o) && !o.cgAnimating || Sn(o)) && K(o, n(M(o.cgKey), e)), o = o.nextSibling;
}
function Tt(t) {
  var r, a;
  const e = t.dom.elements.wrap.getBoundingClientRect(), n = t.dom.elements.container, o = e.height / e.width, s = Math.floor(e.width * window.devicePixelRatio / 8) * 8 / window.devicePixelRatio, i = s * o;
  n.style.width = s + "px", n.style.height = i + "px", t.dom.bounds.clear(), (r = t.addDimensionsCssVarsTo) == null || r.style.setProperty("---cg-width", s + "px"), (a = t.addDimensionsCssVarsTo) == null || a.style.setProperty("---cg-height", i + "px");
}
...
const ie = (t) => `${t.color} ${t.role}`, vs = (t, e) => {
  var n;
  return (n = t.lastMove) != null && n[1] && !t.pieces.has(t.lastMove[1]) && t.lastMove[0][0] === "e" && ["h", "a"].includes(t.lastMove[1][0]) && t.lastMove[0][1] === t.lastMove[1][1] && lo(...M(t.lastMove[0]), ...M(t.lastMove[1])).some((o) => t.pieces.has(o)) ? (e > t.lastMove[0] ? "g" : "c") + e[1] : e;
};
function ks(t) {
  var s, i;
  const e = /* @__PURE__ */ new Map();
  if (t.lastMove && t.highlight.lastMove)
    for (const [r, a] of t.lastMove.entries())
      $(e, r === 1 ? vs(t, a) : a, "last-move");
  if (t.check && t.highlight.check && $(e, t.check, "check"), t.selected && ($(e, t.selected, "selected"), t.movable.showDests)) {
    for (const r of ((s = t.movable.dests) == null ? void 0 : s.get(t.selected)) ?? [])
      $(e, r, "move-dest" + (t.pieces.has(r) ? " oc" : ""));
    for (const r of ((i = t.premovable.customDests) == null ? void 0 : i.get(t.selected)) ?? t.premovable.dests ?? [])
      $(e, r, "premove-dest" + (t.pieces.has(r) ? " oc" : ""));
  }
  const n = t.premovable.current;
  if (n)
    for (const r of n)
      $(e, r, "current-premove");
  else t.predroppable.current && $(e, t.predroppable.current.key, "current-premove");
  const o = t.exploding;
  if (o)
    for (const r of o.keys)
      $(e, r, "exploding" + o.stage);
...
function ys(t, e, n) {
  ...
  for (; i; )
    r = i.getAttribute("cgHash"), o.has(r) ? o.set(r, !0) : s.push(i), i = i.nextElementSibling;
  for (const a of s)
    e.removeChild(a);
  for (const a of t)
    o.get(a.hash) || e.appendChild(n(a));
}
function Cs(t, e) {
  const o = t.drawable.autoShapes.filter((s) => s.piece).map((s) => ({
    shape: s,
    hash: Ps(s),
    current: !1,
    pendingErase: !1
  }));
  ys(o, e, (s) => Es(t, s, t.dom.bounds()));
}
function Ms(t) {
  var s;
  const e = R(t), n = me(t.dom.bounds());
  let o = (s = t.dom.elements.autoPieces) == null ? void 0 : s.firstChild;
  for (; o; )
    zt(o, n(M(o.cgKey), e), o.cgScale), o = o.nextSibling;
}
function Es(t, { shape: e, hash: n }, o) {
  var c, d, h;
  const s = e.orig, i = (c = e.piece) == null ? void 0 : c.role, r = (d = e.piece) == null ? void 0 : d.color, a = (h = e.piece) == null ? void 0 : h.scale, l = F("piece", `${i} ${r}`);
  return l.setAttribute("cgHash", n), l.cgKey = s, l.cgScale = a, zt(l, me(o)(M(s), R(t)), a), l;
}
const Ps = (t) => {
  var e, n, o;
  return [t.orig, (e = t.piece) == null ? void 0 : e.role, (n = t.piece) == null ? void 0 : n.color, (o = t.piece) == null ? void 0 : o.scale].join(",");
};
function Ss(t, e) {
  const n = Xo();
  ln(n, e || {});
  function o() {
    const s = "dom" in n ? n.dom.unbind : void 0, i = us(t, n), r = Gt(() => i.board.getBoundingClientRect()), a = (d) => {
      bs(c), i.autoPieces && Cs(c, i.autoPieces), !d && i.shapes && Zo(c, i);
    }, l = () => {
      Tt(c), ws(c), i.autoPieces && Ms(c);
    }, c = n;
    return c.dom = {
      elements: i,
      bounds: r,
      ...
      redrawNow: a,
      unbind: s
    }, c.drawable.prevSvgHash = "", Tt(c), a(!1), ms(c, l), s || (c.dom.unbind = fs(c, l)), c.events.insert && c.events.insert(i), c;
  }
  return Vo(o(), o);
}
function Ns(t) {
...
class Ts {
  init(e, n) {
    ...
    this.cg = Ss(e, s), this.badgeContainer = document.createElement("div"), this.badgeContainer.className = "chess-prob-badges", e.appendChild(this.badgeContainer);
  }
  updatePosition(e, n, o, s, i) {
    this.cg.set({
      fen: e,
      turnColor: n,
      movable: {
  ...
  showProbabilityArrows(e) {
    const o = [...e].sort((i, r) => i.isChosen && !r.isChosen ? 1 : !i.isChosen && r.isChosen ? -1 : 0).map((i) => ({
      orig: i.from,
      dest: i.to,
      brush: i.isChosen ? "chosenMove" : "candidateMove"
    }));
    this.cg.setAutoShapes(o), this.clearBadges();
    const s = this.cg.state.orientation;
    for (const i of e) {
      const r = i.to, a = r.charCodeAt(0) - 97, l = parseInt(r[1]), c = s === "white" ? a : 7 - a, d = s === "white" ? 8 - l : l - 1, h = document.createElement("div");
  ...
  showPromotionDialog(e, n) {
    return new Promise((o) => {
      const s = this.cg.state.dom.elements.board;
      if (!s) {
        o(null);
        return;
      }
      ...
      p.addEventListener("click", () => {
        ...
        const b = d ? c + f : c - f, k = `${l * 12.5}%`, y = `${b * 12.5}%`, v = document.createElement("div");
        v.className = "chess-promotion-choice", v.style.left = k, v.style.top = y;
        const O = document.createElement("square"), E = document.createElement("piece");
        E.classList.add(n, g.role), O.appendChild(E), v.appendChild(O), p.appendChild(v), v.addEventListener("click", (G) => {
          G.stopPropagation(), m(), o(g.letter);
        });
      }), s.appendChild(p);
    });
  }
...
const xs = 480;
function Nn(t) {
  const n = (t == null ? void 0 : t.mode) === "board-only" ? "board-only" : "sidebar", o = n === "board-only" ? "ca-layout-board-only" : "ca-layout-sidebar", s = t == null ? void 0 : t.boardSize, i = typeof s == "number" && isFinite(s) && s > 0 ? s : xs, r = typeof (t == null ? void 0 : t.moveListContainerId) == "string" ? t.moveListContainerId : null;
  return { mode: n, containerClass: o, boardSizePx: i, moveListContainerId: r };
}
const Bs = '<svg width="18" height="18" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.062 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/></svg>', Ls = '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>', Ds = '<svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6.5"/><path d="M8 7.3v3.7" stroke-linecap="round"/><circle cx="8" cy="4.9" r="0.85" fill="currentColor" stroke="none"/></svg>', Ae = 2500, Ye = 1e3, Je = 2500, et = 100;
function As(t) {
  const e = Math.round(t / et) * et;
  return Math.min(Je, Math.max(Ye, e));
}
class Rs {
  constructor(e, n) {
    this.loadingBlurEl = null, this.loadingModalEl = null, this.loadingProgressFill = null, this.loadingProgressText = null, this.boardBlockerEl = null, this.mustDownloadBlurEl = null, this.mustDownloadModalEl = null, this.settingsModalClose = null, this.onNewGameWithColor = null, this.onMoveNavigate = null, this.onSamplingParamsChanged = null, this.onMetadataChanged = null, this.onLoadModel = null, this.onShowProbabilitiesChanged = null, this.onClaimDraw = null, this.onThemeModeChanged = null, this.onBoardThemeChanged = null, this.onPieceSetChanged = null, this.currentModelPath = "", this.models = [], this.timeControl = "rapid", this.userElo = Ae, this.modelElo = Ae, this.moveListPortalRoot = null, this.container = e;
    const o = n ?? Nn(void 0);
    this.layoutMode = o.mode, this.boardSizePx = o.boardSizePx, this.moveListContainerId = o.moveListContainerId, this.layoutContainerClass = o.containerClass;
  }
  initialize() {
  ...
  updateMoveHistory(e, n) {
    ...
    for (let o = 0; o < e.length; o += 2) {
      const s = Math.floor(o / 2) + 1, i = document.createElement("div");
      i.className = "chess-move-pair";
      const r = document.createElement("div");
      r.className = "chess-move-number", r.textContent = `${s}.`, i.appendChild(r);
      const a = document.createElement("div");
      if (a.className = "chess-move-item", o === n && a.classList.add("current"), a.textContent = e[o], a.onclick = () => {
        var l;
        return (l = this.onMoveNavigate) == null ? void 0 : l.call(this, o);
      }, i.appendChild(a), o + 1 < e.length) {
        const l = document.createElement("div");
        l.className = "chess-move-item", o + 1 === n && l.classList.add("current"), l.textContent = e[o + 1], l.onclick = () => {
          var c;
          return (c = this.onMoveNavigate) == null ? void 0 : c.call(this, o + 1);
        }, i.appendChild(l);
      }
  ...
  showDownloadProgress(e) {
    const n = new AbortController(), o = this.ensureLoadingModal(), s = document.createElement("p");
    s.className = "chess-loading-description";
    const i = e ? `<br><strong>File size:</strong> ${e}` : "";
    s.innerHTML = "Downloading chess AI." + i, o.appendChild(s);
    const r = document.createElement("div");
    r.className = "chess-loading-progress-container";
    const a = document.createElement("div");
    a.className = "chess-loading-progress-bar", this.loadingProgressFill = document.createElement("div"), this.loadingProgressFill.className = "chess-loading-progress-fill", a.appendChild(this.loadingProgressFill), r.appendChild(a), this.loadingProgressText = document.createElement("div"), this.loadingProgressText.className = "chess-loading-progress-text", this.loadingProgressText.textContent = "0%", r.appendChild(this.loadingProgressText), o.appendChild(r);
    const l = document.createElement("button");
    return l.className = "chess-btn chess-btn-danger", l.textContent = "Cancel", l.onclick = () => n.abort(), o.appendChild(l), { abortController: n };
  }
  ...
  showLoadingSpinner(e = "Initializing chess AI...") {
    const n = this.ensureLoadingModal();
    this.loadingProgressFill = null, this.loadingProgressText = null;
    const o = document.createElement("p");
    o.className = "chess-loading-description", o.textContent = e, n.appendChild(o);
    const s = document.createElement("div");
    s.style.display = "flex", s.style.justifyContent = "center";
    const i = document.createElement("div");
    i.className = "chess-spinner chess-spinner-dark", s.appendChild(i), n.appendChild(s);
  }
  hideLoadingModal() {
    var e, n;
  ...
  // Build the blur + modal shell on first use, or reuse it and clear the existing
  // content so a show* call swaps the body in place. Returns the content element
  // to append into.
  ensureLoadingModal() {
    this.loadingBlurEl || (this.loadingBlurEl = document.createElement("div"), this.loadingBlurEl.className = "chess-loading-blur", this.boardContainer.appendChild(this.loadingBlurEl)), this.loadingModalEl || (this.loadingModalEl = document.createElement("div"), this.loadingModalEl.className = "chess-loading-modal", this.boardContainer.appendChild(this.loadingModalEl));
    let e = this.loadingModalEl.querySelector(".chess-loading-modal-content");
    return e ? e.replaceChildren() : (e = document.createElement("div"), e.className = "chess-loading-modal-content", this.loadingModalEl.appendChild(e)), e;
  }
  ...
  showMustDownloadOverlay() {
    return new Promise((e) => {
      ...
      n.className = "chess-loading-modal-content";
      const o = document.createElement("p");
      o.className = "chess-loading-description", o.textContent = "Download the AI model to play", n.appendChild(o);
      const s = document.createElement("button");
      s.className = "chess-btn chess-btn-primary", s.textContent = "Download", s.onclick = () => {
        var i, r;
        (i = this.mustDownloadBlurEl) == null || i.remove(), this.mustDownloadBlurEl = null, (r = this.mustDownloadModalEl) == null || r.remove(), this.mustDownloadModalEl = null, e();
      }, n.appendChild(s), this.mustDownloadModalEl.appendChild(n), this.boardContainer.appendChild(this.mustDownloadModalEl);
    });
  }
  // --- Board Blocker ---
  showBoardBlocker(e, n) {
    ...
    o.className = "chess-board-blocker-content";
    const s = document.createElement("div");
    s.className = "chess-board-blocker-icon", s.innerHTML = Ls, o.appendChild(s);
    const i = document.createElement("div");
    if (i.className = "chess-board-blocker-text", i.textContent = "Load Chess AI", o.appendChild(i), n) {
      const r = document.createElement("div");
      r.className = "chess-board-blocker-size", r.textContent = n, o.appendChild(r);
    }
    this.boardBlockerEl.appendChild(o), this.boardBlockerEl.addEventListener("click", e, { once: !0 }), this.boardContainer.appendChild(this.boardBlockerEl);
  }
  hideBoardBlocker() {
    var e;
  ...
  showNewGameModal() {
    ...
    const o = document.createElement("div");
    o.className = "chess-modal-title", o.textContent = "Play as", n.appendChild(o);
    const s = document.createElement("div");
    s.className = "chess-color-options";
    const i = (b, k) => {
      const y = document.createElement("label");
      y.className = "chess-color-option";
      const v = document.createElement("input");
      v.type = "radio", v.name = "playerColor", v.value = b;
      const O = document.createElement("div");
      O.className = `chess-color-swatch chess-color-swatch-${b}`;
      const E = document.createElement("span");
      return E.textContent = k, y.append(v, O, E), y;
    }, r = i("white", "White"), a = i("black", "Black"), l = r.querySelector("input"), c = a.querySelector("input");
    s.append(r, a);
    const d = (b, k) => {
      k.checked = !0, r.classList.toggle("chess-color-option-selected", b === r), a.classList.toggle("chess-color-option-selected", b === a);
    };
    r.addEventListener("click", () => d(r, l)), a.addEventListener("click", () => d(a, c)), l.addEventListener("change", () => d(r, l)), c.addEventListener("change", () => d(a, c)), d(r, l), n.appendChild(s);
    const h = document.createElement("div");
    h.className = "chess-modal-buttons";
    const p = () => {
      e.remove(), document.removeEventListener("keydown", m);
    }, m = (b) => {
      var k;
      b.key === "Escape" ? p() : b.key === "Enter" && !(document.activeElement instanceof HTMLButtonElement) && (p(), (k = this.onNewGameWithColor) == null || k.call(this, l.checked));
    };
    document.addEventListener("keydown", m);
    const g = document.createElement("button");
    g.className = "chess-btn chess-btn-secondary", g.textContent = "Cancel", g.onclick = p, h.appendChild(g);
    const f = document.createElement("button");
    f.className = "chess-btn chess-btn-primary", f.textContent = "Start", f.onclick = () => {
      var k;
      const b = l.checked;
      p(), (k = this.onNewGameWithColor) == null || k.call(this, b);
    }, h.appendChild(f), n.appendChild(h), e.appendChild(n), e.addEventListener("click", (b) => {
      b.target === e && p();
    }), this.container.appendChild(e), f.focus(), e.addEventListener("keydown", (b) => {
      if (b.key !== "Tab") return;
      const k = e.querySelectorAll(
        'button, [href], input, select, [tabindex]:not([tabindex="-1"])'
      );
      if (k.length === 0) return;
      const y = k[0], v = k[k.length - 1];
      b.shiftKey && document.activeElement === y ? (b.preventDefault(), v.focus()) : !b.shiftKey && document.activeElement === v && (b.preventDefault(), y.focus());
    });
  }
  // --- Model Management ---
  setModelOptions(e, n) {
    ...
    for (const o of e) {
      ...
      s.value = o.path, s.textContent = o.size ? `${o.label} (${o.size})` : o.label, this.modelSelect.appendChild(s);
    }
    ...
    if (this.layoutMode === "board-only")
      if (this.settingsModalClose)
        ...
        const { close: n } = this._openModal(e, () => {
          ...
          const s = this.container.querySelector(".chess-game-wrapper");
          this.settingsPanel.parentNode === e && s && (this.settingsPanel.classList.add("chess-hidden"), s.appendChild(this.settingsPanel));
        });
  ...
  _openModal(e, n) {
    const o = document.createElement("div");
    o.className = "chess-modal", o.setAttribute("role", "dialog"), o.setAttribute("aria-modal", "true"), o.appendChild(e);
    const s = () => {
      o.parentNode && (o.remove(), document.removeEventListener("keydown", i), n());
    }, i = (r) => {
      r.key === "Escape" && (r.preventDefault(), s());
    };
    return document.addEventListener("keydown", i), o.addEventListener("click", (r) => {
      r.target === o && s();
  ...
  _buildDOMSidebar() {
    ...
    const o = document.createElement("div");
    o.className = "chess-control-panel", o.appendChild(this.controlNewGameBtn), o.appendChild(this.claimDrawBtn), n.appendChild(o), e.appendChild(n);
    const s = document.createElement("div");
    s.className = "chess-game-right";
    const i = document.createElement("div");
    i.className = "chess-status";
    const r = document.createElement("div");
    if (r.className = "chess-status-text", this.statusText = document.createElement("div"), this.modelLabel = document.createElement("div"), this.modelLabel.className = "chess-model-label", r.appendChild(this.statusText), r.appendChild(this.modelLabel), i.appendChild(r), i.appendChild(this.gearBtn), s.appendChild(i), this._isIOSSafari()) {
      const a = document.createElement("div");
      a.className = "chess-ios-warning", a.textContent = "iOS Safari detected — GPU acceleration is unavailable. Performance may be slower.", s.appendChild(a);
    }
    this._buildSharedContent(), s.appendChild(this.gameEndBanner), s.appendChild(this.settingsPanel), this.moveListPortalRoot || s.appendChild(this.moveHistoryEl), e.appendChild(s), this.container.appendChild(e);
  }
  _buildDOMBoardOnly() {
    const e = document.createElement("div");
  ...
  _section(e) {
    ...
    if (n.className = "chess-settings-section", e) {
      const o = document.createElement("div");
      o.className = "chess-settings-section-title", o.textContent = e, n.appendChild(o);
    }
  ...
  _buildSettingsPanel() {
    ...
    o.className = "chess-context-label", o.textContent = "Time control", n.appendChild(o), this.timeControlSeg = this._buildSegmented(
      [
        ["bullet", "Bullet"],
        ["blitz", "Blitz"],
        ["rapid", "Rapid"],
      ...
      this.timeControl,
      (v) => {
        this.timeControl = v, this._emitMetadataSettings();
      }
    ), n.appendChild(this.timeControlSeg.el), e.appendChild(n), this.userEloControl = this._buildEloControl("Your Elo", this.userElo, (v) => {
      this.userElo = v, this._emitMetadataSettings();
    }), e.appendChild(this.userEloControl.el), this.modelEloControl = this._buildEloControl("Opponent Elo", this.modelElo, (v) => {
      this.modelElo = v, this._emitMetadataSettings();
    }), e.appendChild(this.modelEloControl.el);
    const s = this._section(), i = document.createElement("div");
    ...
    a.className = "chess-settings-label-text", a.textContent = "Temperature", a.appendChild(this._buildInfo("Lower = more predictable, higher = more creative.")), this.temperatureValue = document.createElement("span"), this.temperatureValue.className = "chess-settings-value", this.temperatureValue.textContent = "1.0", r.append(a, this.temperatureValue), i.appendChild(r), this.temperatureSlider = document.createElement("input"), this.temperatureSlider.type = "range", this.temperatureSlider.min = "0", this.temperatureSlider.max = "2", this.temperatureSlider.step = "0.1", this.temperatureSlider.value = "1", this.temperatureSlider.oninput = () => {
      const v = parseFloat(this.temperatureSlider.value);
      this.temperatureValue.textContent = v.toFixed(1), this._emitSamplingParams();
    }, i.appendChild(this.temperatureSlider);
    const l = document.createElement("div");
    l.className = "chess-slider-range", l.innerHTML = "<span>0</span><span>2.0</span>", i.appendChild(l), s.appendChild(i);
    ...
    h.className = "chess-settings-label-text", h.textContent = "Top-K", h.appendChild(this._buildInfo("Number of candidate moves to sample from.")), this.topKValue = document.createElement("span"), this.topKValue.className = "chess-settings-value", this.topKValue.textContent = "1", d.append(h, this.topKValue), c.appendChild(d), this.topKSlider = document.createElement("input"), this.topKSlider.type = "range", this.topKSlider.min = "1", this.topKSlider.max = "20", this.topKSlider.step = "1", this.topKSlider.value = "1", this.topKSlider.oninput = () => {
      const v = parseInt(this.topKSlider.value);
      this.topKValue.textContent = String(v), this._emitSamplingParams();
    }, c.appendChild(this.topKSlider);
    const p = document.createElement("div");
    p.className = "chess-slider-range", p.innerHTML = "<span>1</span><span>20</span>", c.appendChild(p), s.appendChild(c);
    ...
    f.className = "chess-switch", this.showProbsCheckbox = document.createElement("input"), this.showProbsCheckbox.type = "checkbox", this.showProbsCheckbox.onchange = () => {
      var v;
      (v = this.onShowProbabilitiesChanged) == null || v.call(this, this.showProbsCheckbox.checked);
    };
    const b = document.createElement("span");
    b.className = "chess-switch-track", f.append(this.showProbsCheckbox, b), m.append(g, f), s.appendChild(m), this.modelSection = this._section();
    const k = document.createElement("div");
    k.className = "chess-settings-field";
    const y = document.createElement("div");
    y.className = "chess-model-row", this.modelSelect = document.createElement("select"), y.appendChild(this.modelSelect), this.loadModelBtn = document.createElement("button"), this.loadModelBtn.className = "chess-btn chess-btn-primary chess-btn-sm", this.loadModelBtn.textContent = "Load", this.loadModelBtn.style.display = "none", this.loadModelBtn.onclick = () => {
      var v;
      return (v = this.onLoadModel) == null ? void 0 : v.call(this, this.modelSelect.value);
    }, y.appendChild(this.loadModelBtn), this.modelSelect.onchange = () => this._updateLoadBtnState(), k.appendChild(y), this.modelSection.appendChild(k), this._buildAppearanceField();
  }
  ...
  _buildThemeSelect(e, n, o, s = !1) {
    const i = document.createElement("div");
    i.className = "chess-context-control" + (s ? " chess-context-control-wide" : "");
    ...
    return a.onchange = o, i.appendChild(r), i.appendChild(a), a;
  }
  setThemePicker(e, n) {
  ...
  _buildInfo(e) {
    ...
    o.type = "button", o.className = "chess-info-btn", o.setAttribute("aria-label", "More information"), o.setAttribute("aria-expanded", "false"), o.innerHTML = Ds;
    const s = document.createElement("span");
    s.className = "chess-info-pop", s.setAttribute("role", "tooltip"), s.textContent = e;
    const i = (l) => {
    ...
    function a() {
      n.classList.remove("chess-info-open"), o.setAttribute("aria-expanded", "false"), document.removeEventListener("click", i), document.removeEventListener("keydown", r);
    }
    return o.addEventListener("click", (l) => {
      l.stopPropagation();
      const c = n.classList.toggle("chess-info-open");
      o.setAttribute("aria-expanded", String(c)), c ? (document.addEventListener("click", i), document.addEventListener("keydown", r)) : (document.removeEventListener("click", i), document.removeEventListener("keydown", r));
    }), n.append(o, s), n;
  }
  // Segmented (radiogroup) control — a row of pill buttons, one active.
  _buildSegmented(e, n, o) {
    const s = document.createElement("div");
    s.className = "chess-segmented", s.setAttribute("role", "radiogroup");
    ...
    for (const [a, l] of e) {
      ...
      c.type = "button", c.className = "chess-segmented-item", c.setAttribute("role", "radio"), c.textContent = l, c.onclick = () => {
        r(a), o(a);
      }, i.set(a, c), s.appendChild(c);
    }
    return r(n), { el: s, set: r };
  }
  ...
  _buildEloControl(e, n, o) {
    const s = document.createElement("div");
    s.className = "chess-settings-field chess-elo-field";
    ...
    a.className = "chess-settings-value", i.append(r, a), s.appendChild(i);
    const l = document.createElement("input");
    l.type = "range", l.min = String(Ye), l.max = String(Je), l.step = String(et), l.value = String(Ae), s.appendChild(l);
    const c = document.createElement("div");
    c.className = "chess-slider-foot";
    const d = document.createElement("span");
    d.textContent = String(Ye);
    const h = document.createElement("span");
    h.textContent = String(Je);
    const p = document.createElement("label");
    p.className = "chess-elo-unknown";
    const m = document.createElement("input");
    m.type = "checkbox", p.append(m, document.createTextNode("Unknown")), c.append(d, p, h), s.appendChild(c);
    const g = () => {
      const b = m.checked;
      l.disabled = b, s.classList.toggle("chess-elo-unknown-on", b), a.textContent = b ? "—" : l.value;
    };
    l.oninput = () => {
      a.textContent = l.value, o(Number(l.value));
    }, m.onchange = () => {
      g(), o(m.checked ? "missing" : Number(l.value));
    };
    const f = (b) => {
      b === "missing" ? m.checked = !0 : (m.checked = !1, l.value = String(As(b))), g();
    };
    return f(n), { el: s, set: f };
  }
...
class Os {
  constructor(e, n = {}, o = []) {
    this.mql = null, this.mqlListener = null, this.container = e, this.roots = [e, ...o], this.mode = n.mode ?? "auto", this.board = n.board ?? "default", this.pieces = n.pieces ?? "cburnett", this.accent = n.accent;
  }
...
function Oe(t) {
  ...
  const { fromFile: e, fromRank: n, toFile: o, toRank: s, role: i, promotion: r } = t;
  return (r || i) << 12 | e << 9 | n << 6 | o << 3 | s;
}
function Dt(t) {
  const e = Ks[t];
  if (e) return e;
  const n = t >> 12 & 15, o = Bt(t >> 9 & 7), s = Lt(t >> 6 & 7), i = Bt(t >> 3 & 7), r = Lt(t & 7), a = Hs[n];
  return o + s + i + r + (a || "");
}
const Gs = 32774, zs = 61952, Us = 62464, Tn = 15, Ws = 1, qs = 2, js = 1, Vs = 2, Xs = 3, Qs = 4, Zs = {
  bullet: Xs,
  blitz: Vs,
  rapid: js,
  classical: Qs
...
function At(t) {
  ...
  const n = Math.max(1e3, Math.min(e, 2500)), s = (Math.min(Math.floor((n + 50) / 100) * 100, 2500) - 1e3) / 100;
  return Tn << 12 | Ws << 9 | s + 1 << 3;
}
function Js(t) {
  if (!t || t === "missing")
    return Us;
...
function ei(t) {
  return [
    Js(t == null ? void 0 : t.timeControl),
...
class oi {
  ...
  async initSession(e, n) {
    ...
    try {
      o.env.wasm.numThreads = 1, o.env.wasm.proxy = !1, o.env.logLevel = "error";
      const h = {
        logSeverityLevel: 3,
      ...
      this.session = await o.InferenceSession.create(s, h), this.inputType = "int32", this.inputName = "x", this.outputName = "select_8", this.modelConfig = n ?? null;
  ...
  usesBinLogitsOutput() {
    var e;
    return Ys(this.outputName, (e = this.modelConfig) == null ? void 0 : e.outputMode);
  }
  getLegalMovesAsBin(e) {
    ...
    const o = n.allDests(), s = [];
    for (const [i, r] of o) {
      const a = n.board.get(i);
      if (!a) continue;
      const l = Ie[a.role], c = S(i), d = _(i);
      for (const h of r) {
        const p = S(h), m = _(h);
        if (l === "k") {
          const b = n.board.get(h);
          if (b && b.color === a.color && b.role === "rook") {
            const k = p > c, y = a.color === "white" ? k ? "e1g1" : "e1c1" : k ? "e8g8" : "e8c8";
            s.push(we[y]);
            continue;
          }
        }
  ...
  async getMove(e) {
    if (await new Promise((s) => setTimeout(s, 100)), !this.isReady || !this.session)
      throw new Error("ONNX model not initialized");
    let n = null, o = null;
    try {
      n = this.buildModelInput(e), o = await this.session.run({ [this.inputName]: n });
      const s = this.getLegalMovesAsBin(e), { sampledBinMove: i, topCandidates: r } = this.sampleBinMove(o, s), a = Dt(i), l = r.map((c) => {
        const d = Dt(c.binMove);
        return {
      ...
      return console.error("Error during ONNX inference:", s), null;
    } finally {
      if (n != null && n.dispose && n.dispose(), o)
        for (const s of Object.values(o))
          s != null && s.dispose && s.dispose();
    }
  }
  buildModelInput(e) {
    const n = this.getOnnxRuntime(), o = le.default(), s = [];
    for (const a of e) {
      const l = Fe(a);
      ...
      if (h !== void 0)
        ...
        const p = Ie[c.role], m = {
          ...
          toRank: _(l.to),
          role: Re[p],
          promotion: l.promotion ? tt[Ie[l.promotion]] : void 0
        };
        s.push(Oe(m));
      }
      o.play(l);
    }
    const i = ti(s, this.modelConfig ?? {}), r = this.inputType === "int64" ? BigInt64Array.from(i, (a) => BigInt(a)) : Int32Array.from(i);
    return new n.Tensor(this.inputType, r, [1, i.length]);
  }
  sampleBinMove(e, n) {
    var G, X;
    const o = e[this.outputName], s = o.cpuData ?? o.data, i = [], r = {
      outputMode: this.usesBinLogitsOutput() ? "bin_logits_v1" : (G = this.modelConfig) == null ? void 0 : G.outputMode,
      outputTokenizer: (X = this.modelConfig) == null ? void 0 : X.outputTokenizer,
      binToReal: _s
    };
    for (const w of n) {
      const P = ni(w, r);
      if (P === void 0) throw new Error(`Missing tokenizer mapping for bin move: ${w}`);
      const x = s[P];
      if (x === void 0 || !isFinite(x)) throw new Error(`Invalid logit for token ${P} (bin ${w}): ${x}`);
      i.push({ binMove: w, logit: x });
    }
    if (i.sort((w, P) => P.logit - w.logit), i.length === 0)
      return console.error("No legal moves"), { sampledBinMove: 0, topCandidates: [] };
    const a = this.temperature <= 0 ? 1e-9 : this.temperature, l = i.map((w) => w.logit / a), c = l[0], d = l.map((w) => Math.exp(w - c)), h = d.reduce((w, P) => w + P, 0), p = d.map((w) => w / h), m = Math.min(20, i.length), g = i.slice(0, m).map((w, P) => ({
      binMove: w.binMove,
      probability: p[P]
    }));
    ...
    const f = Math.min(this.topK, i.length), b = p.slice(0, f), k = b.reduce((w, P) => w + P, 0), y = b.map((w) => w / k), v = Math.random();
    let O = 0, E = f - 1;
...
class si {
  ...
  async getCachedModel(e) {
    ...
    return this.db || await this.initDB(), new Promise((o, s) => {
      const a = this.db.transaction(this.storeName, "readonly").objectStore(this.storeName).get(n);
      a.onerror = () => s(a.error), a.onsuccess = () => o(a.result);
    });
  }
  async cacheModel(e, n) {
    const o = n || this.modelUrl;
    return this.db || await this.initDB(), new Promise((s, i) => {
      const l = this.db.transaction(this.storeName, "readwrite").objectStore(this.storeName).put(e, o);
      l.onerror = () => i(l.error), l.onsuccess = () => s();
    });
  }
  async downloadModel(e, n, o) {
    const s = o || this.modelUrl;
    try {
      const i = await fetch(s, { signal: n });
      if (!i.ok)
      ...
      return await this.cacheModel(h, s), h;
    } catch (i) {
      throw console.error("[ModelManager] Download error:", i), i;
    }
  }
  async getModel(e, n, o) {
    const s = o || this.modelUrl;
    try {
      const i = await this.getCachedModel(s);
      return i ? (console.debug("[ModelManager] Using cached model"), e == null || e(100), i) : (console.debug("[ModelManager] Downloading model..."), await this.downloadModel(e, n, s));
    } catch (i) {
...
function pt(t) {
  return je(t.toSetup()).split(" ").slice(0, 4).join(" ");
}
function Rt(t) {
  const e = /* @__PURE__ */ new Map();
  return e.set(pt(t), 1), { counts: e };
}
function ii(t, e) {
  const n = pt(e), o = (t.counts.get(n) ?? 0) + 1;
  return t.counts.set(n, o), o;
}
function Ot(t, e) {
  return t.counts.get(pt(e)) ?? 0;
}
function He(t, e) {
  if (e >= 5)
    return {
...
class ri {
  constructor(e) {
    this.config = e, this.models = e.models, this.currentModelPath = e.models[0].path, this.modelManager = new si(this.currentModelPath), this.aiProvider = new oi(e.onnxRuntime, e.onnxSessionOptions), this.boardUI = new Ts(), this.pos = le.default(), this.moveHistory = [], this.sanHistory = [], this.uciHistory = [], this.moveTopMoves = [], this.showProbabilities = !1, this.isHumanWhite = !0, this.gameInProgress = !1, this.currentPositionIndex = -1, this.playMetadata = this.getPlayMetadataFromModel(e.models[0]), this.repetitionTracker = Rt(this.pos), this.currentDrawState = He(
      this.pos,
  ...
  async init() {
    ...
    this.panels = new Rs(e, Nn(this.config.layout)), this.panels.initialize();
    const n = this.panels.getMoveListPortalRoot(), o = n ? [n] : [];
    this.themeManager = new Os(e, this.config.theme, o), this.themeManager.apply(), this.boardUI.init(this.panels.getBoardContainer(), this.onHumanMove.bind(this)), this.panels.onNewGameWithColor = (r) => this.startNewGame(r), this.panels.onMoveNavigate = (r) => this.navigateToMove(r), this.panels.onSamplingParamsChanged = (r) => {
      var a;
    ...
    const s = await this.modelManager.getCachedModel(this.currentModelPath);
    if (s) {
      this.panels.showLoadingSpinner();
      const r = this.models.find((a) => a.path === this.currentModelPath);
      this.applyPlayMetadataToModels(), await this.aiProvider.initSession(s, r), this.panels.hideLoadingModal(), await this.startGame();
    } else {
      const r = this.models.find((a) => a.path === this.currentModelPath);
  ...
  async onHumanMove(e, n) {
    ...
    const o = be(e);
    if (o === void 0) return;
    const s = this.pos.board.get(o);
    if (s && s.role === "pawn" && (n[1] === "1" || n[1] === "8")) {
      const r = s.color === "white" ? "white" : "black", a = await this.boardUI.showPromotionDialog(n, r);
      if (!a) {
        this.updateBoard();
        return;
      }
  ...
  playMove(e) {
    ...
    const o = Yn(this.pos, n);
    this.pos.play(n);
    const s = ii(this.repetitionTracker, this.pos);
    return this.currentDrawState = He(this.pos, s), this.moveHistory.push(n), this.sanHistory.push(o), this.uciHistory.push(e), this.moveTopMoves.push([]), this.currentPositionIndex = this.moveHistory.length - 1, this.updateBoard(), this.panels.updateMoveHistory(this.sanHistory, this.currentPositionIndex), this.checkGameEnd(), !0;
  }
  updateBoard() {
    const e = je(this.pos.toSetup()), n = this.pos.turn, o = Xn(this.pos);
    let s;
    if (this.moveHistory.length > 0) {
      const r = this.moveHistory[this.moveHistory.length - 1];
      $e(r) && (s = [D(r.from), D(r.to)]);
    }
    const i = this.pos.isCheck();
    this.boardUI.updatePosition(e, n, o, s, i);
  }
  async getAIMove() {
    if (!(!this.gameInProgress || this.isGameOver())) {
      ...
      try {
        ...
        if (e) {
          const { uciMove: n, topMoves: o } = e;
          this.playMove(n), o && (this.moveTopMoves[this.moveTopMoves.length - 1] = o), this.showProbabilities && o && this.boardUI.showProbabilityArrows(o.slice(0, this.aiProvider.topK));
        } else
  ...
  checkGameEnd() {
    ...
    if (this.pos.isStalemate()) {
      this.gameInProgress = !1, this.panels.showGameEndBanner("Draw: Stalemate!", !0), this.updateStatus();
      return;
    }
    if (this.pos.isInsufficientMaterial()) {
      this.gameInProgress = !1, this.panels.showGameEndBanner("Draw: Insufficient Material!", !0), this.updateStatus();
      return;
    }
    if (this.currentDrawState.automaticDraw) {
      this.gameInProgress = !1;
      const e = _e[this.currentDrawState.automaticDraw] ?? "FIDE draw";
      this.panels.showGameEndBanner(`Draw: ${e}!`, !0), this.updateStatus();
      return;
    }
    this.updateStatus();
  }
  updateStatus() {
    let e = "";
    const n = this.pos.turn === "white" ? "White" : "Black";
    if (this.claimedDrawText)
      e = `Game is drawn by claimed ${this.claimedDrawText}.`;
    else if (this.pos.isCheckmate()) {
      const o = this.pos.turn === "white" ? "Black" : "White";
      e = `Game over: ${n.toLowerCase()} is in checkmate. ${o} wins!`;
    } else if (this.pos.isStalemate())
      e = `Game is drawn. ${n} is stalemated.`;
    else if (this.pos.isInsufficientMaterial())
      e = "Game is drawn by insufficient material.";
    else if (this.currentDrawState.automaticDraw)
      e = `Game is drawn by ${(_e[this.currentDrawState.automaticDraw] ?? "FIDE draw").toLowerCase()}.`;
    else if (this.pos.isCheck() && (e = `${n} is in check! `), e += `${n} to move.`, this.currentDrawState.claimableDraws.length > 0) {
      const o = this.getClaimableDrawLabels();
      e += ` ${n} may claim a draw by ${o.join(" or ")}.`;
    }
    this.panels.updateStatus(e), this.updateClaimDrawAvailability();
  }
  navigateToMove(e) {
    var r;
    const n = le.default();
    ...
    for (let a = 0; a <= e && a < this.moveHistory.length; a++) {
      ...
      n.play(l), a === e && $e(l) && (o = [D(l.from), D(l.to)]);
    }
    const s = je(n.toSetup()), i = n.isCheck();
    e === this.moveHistory.length - 1 ? (this.currentPositionIndex = -1, this.pos = n, this.updateBoard()) : (this.currentPositionIndex = e, this.boardUI.setViewOnly(s, o, i)), this.boardUI.clearArrows(), this.showProbabilities && ((r = this.moveTopMoves[e]) == null ? void 0 : r.length) > 0 && this.boardUI.showProbabilityArrows(this.moveTopMoves[e].slice(0, this.aiProvider.topK)), this.panels.updateMoveHistory(this.sanHistory, e), this.updateClaimDrawAvailability();
  }
  isAtPresentPosition() {
    return this.currentPositionIndex === -1 || this.currentPositionIndex === this.moveHistory.length - 1;
  }
  async startNewGame(e) {
    this.pos = le.default(), this.moveHistory = [], this.sanHistory = [], this.uciHistory = [], this.moveTopMoves = [], this.isHumanWhite = e, this.currentPositionIndex = -1, this.repetitionTracker = Rt(this.pos), this.currentDrawState = He(
      this.pos,
      Ot(this.repetitionTracker, this.pos)
  ...
  claimDraw() {
    ...
    this.claimedDrawText = e.join(" or ").toLowerCase(), this.gameInProgress = !1, this.panels.setClaimDrawAvailable(!1), this.panels.showGameEndBanner(`Draw claimed: ${e.join(" or ")}!`, !0), this.updateStatus();
  }
  getClaimableDrawLabels() {
    return this.currentDrawState.claimableDraws.map((e) => _e[e] ?? e);
  }
  isHumanTurn() {
  ...
  async loadModel(e) {
    const n = this.models.find((s) => s.path === e);
    if (!n) {
      console.error("Model not found:", e);
      return;
    }
    this.currentModelPath = e, this.applyPlayMetadataToModels();
    let o = await this.modelManager.getCachedModel(e);
    if (!o) {
      const { abortController: s } = this.panels.showDownloadProgress(n.size);
      try {
        o = await this.modelManager.getModel(
    ...
    this.panels.showLoadingSpinner(), await this.aiProvider.initSession(o, n), this.panels.hideLoadingModal(), this.panels.hideBoardBlocker(), this.panels.setCurrentModel(e), await this.startGame();
  }
  async beginDownloadFlow() {
    const e = this.models.find((s) => s.path === this.currentModelPath), n = e == null ? void 0 : e.size, { abortController: o } = this.panels.showDownloadProgress(n);
    this.applyPlayMetadataToModels();
    try {
      const s = await this.modelManager.getModel(
        (i) => this.panels.updateLoadingProgress(i),
        o.signal,
        this.currentModelPath
      );
      this.panels.showLoadingSpinner(), this.applyPlayMetadataToModels(), await this.aiProvider.initSession(s, e), this.panels.hideLoadingModal(), this.panels.hideBoardBlocker(), await this.startGame();
    } catch (s) {
      this.panels.hideLoadingModal(), s.name === "AbortError" ? (await this.panels.showMustDownloadOverlay(), await this.beginDownloadFlow()) : console.error("Model download failed:", s);
    }
  }
  getPlayMetadataFromModel(e) {
  ...
  getMetadataContext() {
    const { timeControl: e, userElo: n, modelElo: o } = this.playMetadata;
    return {
      timeControl: e,
      whiteElo: this.isHumanWhite ? n : o,
      blackElo: this.isHumanWhite ? o : n
    };
  }
  /**
